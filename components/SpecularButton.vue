...
const propsRef = ref({
  ...
  shineSize: props.shineSize,
  shineFade: props.shineFade,
...
watch(() => [props.radius, props.lineColor, props.baseColor, props.intensity,
  props.shineSize, props.shineFade, props.thickness, props.speed,
  props.followMouse, props.proximity, props.autoAnimate], () => {
  propsRef.value = {
    radius: props.radius,
    lineColor: props.lineColor,
    baseColor: props.baseColor,
...
onMounted(() => {
  ...
  const onPointerMove = (e: PointerEvent) => {
    ...
    const t = Math.max(0, 1 - dist / Math.max(propsRef.value.proximity, 1));
